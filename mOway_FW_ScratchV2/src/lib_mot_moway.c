...
//*           ,unsigned char, unsigned char)            *
//*******************************************************
//*Descripción: Command to make Moway walk straight     *
//*on. It is necessary to specify the speed, the        *
//*direction, the kind of command and the time or the   *
//*distance.                                            *
//*******************************************************
//*Variables de entrada:- MOT_VEL    : 0    - 100       *
//*                     - FWDBACK    : FWD  - BACK      *
//*                     - COMTYPE    : TIME - DISTANCE  *
//*                     - MOT_T_DIST : 0    - 255       *
//*Variables de salida:                                 *
//*Salida:              - 0: Correct sending            *
//*                     - 1: Wrong sending              *
//*                     - 2: Wrong data                 *
//*******************************************************
...
//*****************************************************
//* MOT_CUR(unsigned char, unsigned char, unsigned    *
...
//*                         -STATUS_KM                *
//*Output variables:        					      *
//*Output:             - Pointer to 2 unsigened char  *
//*****************************************************
...
//*              Stop_I2C2()			              *
//*****************************************************
//*		Descripción:STOP condition for the			  *
	...
	{	
		...
		if(i==2)
		{
			...
			{	
				...
				SCL_SOFT=0;			//Hacemos 0 SCL
				SCL_TRIS=0;			//Hacemos SCL como salida (Nivel lógico 0)			
			}
			else
			{
...
//*            		OUT_ACK2()			              *
//*****************************************************
//*		Descripción: Creates an ACK signal			  *
//*****************************************************
...
//*            		OUT_NACK2()			              *
//*****************************************************
//*		Descripción: Creates a NACK signal 		      *
//*****************************************************
...
//*****************************************************
//*      MOT_SND_I2C_3D(unsigned char, unsigned char, *
//*                     unsigned char)                *
//*****************************************************
//*Description:Low level I2C communication function   *
